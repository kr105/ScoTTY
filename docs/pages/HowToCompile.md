...
docker run --rm -it -v $(pwd)/builds:/builds -e USR_UID=$(id -u) -e USR_GID=$(id -g) cyd01/cross-gcc "git clone https://github.com/cyd01/KiTTY.git ; cd KiTTY/src/windows ; make -f MAKEFILE.MINGW cross ; cd /builds ; ls -l"
```
